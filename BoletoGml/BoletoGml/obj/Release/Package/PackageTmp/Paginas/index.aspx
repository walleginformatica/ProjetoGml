<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BoletoGml.Paginas.index" %>
                ...
                <div class="features">
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            <i class="fa fa-bullhorn"></i>
                            <h2>CONTABILIDADE</h2>
                            <h3>Gestão geral do setor Contabilidade<br /><a href="#">Saber Mais..</a></h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h3>Gestão geral do setor Cobrança Extrajucial<br /><a href="#">Saber Mais..</a></h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h3>Gestão geral do setor Cobrança Judicial<br /><a href="#">Saber Mais..</a></h3>
                        </div>
                    </div><!--/.col-md-4-->
        ...
        <div class="container">
            <div class="center wow fadeInDown">
                ...
                <p class="lead">
                    ...
                    <br>interatividade que se dá, inclusive, pessoalmente, por meio de duas visitas semanais ao Condomínio, 
                        ...
                        <div class="media">
                            <div class="parrent pull-left">
                                <ul class="nav nav-tabs nav-stacked">
                                    ...
                                    <li class="active"><a href="#tab2" data-toggle="tab" class="analistic-02">Dicas</a></li>
                                    <li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Dicas</a></li>
                                    <li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Dicas</a></li>
                                    <li class=""><a href="#tab5" data-toggle="tab" class="tehnical">Dicas</a></li>
                                </ul>
                            </div>
