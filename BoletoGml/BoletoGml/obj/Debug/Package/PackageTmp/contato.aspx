                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 map-content">
                        <ul class="row">
                            <li class="col-sm-6">
                                <address>
                                    <h5>GML ADMINISTRAÇÃO E GESTÃO DE CONDOMÍNIOS</h5>
    ...
    <section id="contact-page">
        <div class="container">
            <div class="center">        
                ...
                <p class="lead">SOLICITE UMA PROPOSTA!</p>
            </div> 
                ...
                <div class="status alert alert-success" style="display: none"></div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnEnviarEmail" Text="Enviar" runat="server" CssClass="btn btn-primary btn-lg" required="required" OnClick="btnEnviarEmail_Click" />
                        </div>
                    </div>
