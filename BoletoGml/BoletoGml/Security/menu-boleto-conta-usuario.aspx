<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menu-boleto-conta-usuario.aspx.cs" Inherits="BoletoGml.Security.menu_boleto_conta_usuario" %>
    ...
    <section id="feature" >
        <div class="container">
           <div class="center wow fadeInDown">
                ...
                <p class="lead">Altere seus Dados<br /></p>
            </div>
            ...
            <div class="container">
                ...
                <br />
                <asp:TextBox ID="txtSacado" runat="server" Width="300px" TextMode="SingleLine" Visible="false"  />
                <br />
                <b>Número do telefone</b>
                <br />
                <asp:TextBox ID="txtFone" runat="server" Width="300px" TextMode="Phone"  />
                <br />
                <br />
                <b>E-mail</b>
                <br />
                <asp:TextBox ID="txtEmail" runat="server" Width="300px" TextMode="Email" />
                <br />
                <br />
                
                <asp:CheckBox ID="CheckBox" runat="server" OnCheckedChanged="CheckBox_CheckedChanged" />&nbsp;<label>Não desejo receber boleto em papel</label>
                <br />
                <br />
                <b>Digite a senha para confirmar as alterações</b>
                <br />
                <asp:TextBox ID="txtSenha" runat="server" Width="300px" TextMode="Password"  />
                <br />
                <br />
                ...
                <div class="col-sm-8">
                    <div class="media contact-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        <div class="media-body">
                            ...
                            <p>Entre em contato com a gente +55 (11)2225-0040</p>
                        </div>
                    </div>
                </div>
            </div>
